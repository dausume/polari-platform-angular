...
@Component({
  standalone: true,
  selector: 'create-filter-chain-dialog',
  template: `
    <h2 mat-dialog-title>Create Filter Chain</h2>
    <mat-dialog-content>
      ...
      <mat-form-field appearance="outline" class="full-width">
        ...
        <textarea matInput [(ngModel)]="description" rows="3"
                  placeholder="Describe the purpose of this filter chain..."></textarea>
      </mat-form-field>
    </mat-dialog-content>
...
export class CreateFilterChainDialogComponent {
  name = '';
  description = '';

  constructor(public dialogRef: MatDialogRef<CreateFilterChainDialogComponent>) {}
}

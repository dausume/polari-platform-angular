...
import { NoCodeStateInstanceComponent } from '@components/custom-no-code/editor/no-code-state-instance/no-code-state-instance';
import { NoCodeStateInstanceComponentD3 } from '@components/custom-no-code/editor/no-code-interface/no-code-state-instance-d3/no-code-state-instance-d3';
import { NoCodeInterfaceComponent } from '@components/custom-no-code/editor/no-code-interface/no-code-interface';
...
import { SlotConfigurationPopupComponent } from '@components/custom-no-code/popups/slot-configuration-popup/slot-configuration-popup.component';
...
import { SystemNoticeComponent } from '@components/demo-notice/system-notice.component';
...
@NgModule({
  ...
  imports: [
    ...
    DemoNoticeComponent, SystemNoticeComponent,
